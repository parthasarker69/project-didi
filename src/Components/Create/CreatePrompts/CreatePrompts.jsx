    ...
    return (
        <div className="bg-[#303030] mt-4 p-10 text-white">
            <div className="flex items-center justify-between">
                <p className="flex items-center gap-3 text-2xl font-extrabold mb-7"><AiOutlinePlus></AiOutlinePlus>Create Prompt</p>
                <Link to={'/library'}>
            ...
            <div className="mb-10">
                ...
                <div className="w-3/5 text-white bg-white py-2 px-2 border-0 mb-7 rounded-md">
                    <input className="w-full outline-none text-black " type="text" placeholder={`What is the name of the Prompt`} />
                </div>
            </div>
            ...
            <div className="mt-10">
                <button className="bg-white py-2 px-6 rounded-md text-black flex items-center gap-3 ">
                    <AiOutlinePlus></AiOutlinePlus>Create Prompt
                </button>
            </div>
        </div>
    );
